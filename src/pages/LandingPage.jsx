...
// Respuestas predefinidas del mini-chat de la landing (sin backend)
const DEMO_RESPONSES = {
    "¿Cuánto puedo ahorrar?": {
        mood: "happy",
        text: "Con tus ingresos actuales y un plan de ahorro del 20%, podrías ahorrar unos 400€ al mes. En un año serían 4.800€ 🚀 ¡Regístrate para ver tu plan personalizado!",
    },
    "Analiza mis gastos": {
        mood: "thinking",
        text: "En cuentas de demo veo que el 48% de tus gastos son fijos (alquiler, suscripciones) y un 30% es ocio. Hay margen de mejora. Regístrate y analizo tus datos reales 📊",
    },
    "¿Cómo llego a mi objetivo?": {
        mood: "happy",
        text: "Si ahorras 300€/mes, alcanzarás tu objetivo de viaje en 5 meses 🎯 ¿Quieres que te ayude a crear un plan paso a paso? ¡Regístrate gratis!",
    },
    "Dame un consejo": {
        mood: "normal",
        text: "Regla del 50/30/20: destina el 50% a necesidades, 30% a ocio y 20% al ahorro. Es el punto de partida ideal para cualquier persona 💡",
    },
};
...
export default function LandingPage() {
    ...
    const sendDemoMessage = (prompt) => {
        ...
        setChatHistory(prev => [...prev, userMsg, coachMsg]);
        ...
        <div className="landing-page">
            ...
            <nav className={`landing-nav ${scrolled ? "landing-nav--scrolled" : ""}`}>
                <div className="landing-nav-inner">
                    <div className="landing-nav-brand">
                        <BilletinAvatar size={38} mood="happy" />
                        <span className="landing-nav-logo">BilleterIA</span>
                    </div>
                    <div className="landing-nav-actions">
                        <a href="#demo-chat" className="landing-nav-link">Demo</a>
            ...
            <section className="landing-hero">
                ...
                <div className="landing-stats">
                    <div className="landing-stat">
                        <span className="landing-stat-number">2.500+</span>
                        <span className="landing-stat-label">usuarios activos</span>
                    </div>
                    <div className="landing-stat-divider" />
                    <div className="landing-stat">
                        <span className="landing-stat-number">95%</span>
                        <span className="landing-stat-label">satisfacción</span>
                    </div>
                    <div className="landing-stat-divider" />
                    <div className="landing-stat">
                        <span className="landing-stat-number">4.8 ⭐</span>
                        <span className="landing-stat-label">valoración media</span>
                    </div>
                </div>
            ...
            <footer className="landing-footer">
                <div className="landing-footer-brand">
                    <BilletinAvatar size={28} mood="normal" />
                    <span>BilleterIA</span>
                </div>
                <p>Proyecto TFM · Finanzas personales con IA · 2026</p>
            </footer>
